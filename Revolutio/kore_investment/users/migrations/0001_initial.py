# Generated by Django 4.0.10 on 2023-07-09 17:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("from_ldap", models.BooleanField(default=False, editable=False, verbose_name="LDAP user")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("alert_instance", models.CharField(max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("app_ui_config", models.TextField(null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("approval_status", models.CharField(max_length=100, verbose_name="Approval Status")),
                ("approval_code", models.TextField(max_length=256, null=True, verbose_name="Approval Code")),
                (
                    "create_view_element_id",
                    models.CharField(max_length=256, verbose_name="Create View Element Id"),
                ),
                ("approver_group", models.CharField(max_length=256, verbose_name="Approver Group")),
                ("approval_type", models.CharField(max_length=256, verbose_name="Approval Type")),
                ("approval_comments", models.TextField(null=True, verbose_name="Approval Comments")),
                (
                    "transaction_id",
                    models.CharField(
                        default="NULL", max_length=255, null=True, verbose_name="Transaction Id"
                    ),
                ),
                ...
                ("modify_column", models.TextField(null=True, verbose_name="Modify Column")),
                (
                    "type_of_approval",
                    models.CharField(
                ...
                (
                    "hierarchy_group",
                    models.CharField(max_length=256, null=True, verbose_name="Hierarchy Group"),
                ),
                ("approval_level_config", models.TextField(null=True, verbose_name="Approval Level Config")),
                ("approver_user", models.CharField(max_length=1026, null=True, verbose_name="Approver User")),
                (
                ...
                (
                    ...
                    models.CharField(max_length=50, null=True, verbose_name="Current Decision Box Id"),
                ),
                (
                    "approver_type",
                    models.CharField(
                        default="several", max_length=20, null=True, verbose_name="Approver Type"
                    ),
                ),
                ("approved_by", models.CharField(max_length=526, null=True, verbose_name="Approved By")),
                ("approval_audit_log", models.TextField(null=True, verbose_name="Audit Log")),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("output_elements", models.TextField(null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("active_to", models.DateField(null=True, verbose_name="Active To")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("event_triggered_date", models.DateTimeField(auto_now=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_by", models.CharField(max_length=100)),
                ("created_date", models.DateTimeField(auto_now=True)),
                ("external_app_ui_config", models.TextField(null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("share_with_group", models.TextField(null=True)),
                ("theme_name", models.CharField(max_length=255, null=True)),
                ("breadcrumbs", models.TextField(null=True)),
                ("created_by", models.CharField(max_length=100)),
                ("created_date", models.DateTimeField(auto_now=True)),
                ("process_flow_design", models.TextField(null=True)),
                ("tab_header_color_config", models.TextField(null=True)),
                ("design_mode", models.BooleanField(default=False, null=True)),
                ("process_icon", models.CharField(blank=True, max_length=255, null=True)),
                ("subprocess_icon", models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name="Ocr_Template",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("redirect_status", models.CharField(blank=True, max_length=100, null=True)),
                ("run_left", models.CharField(blank=True, max_length=100, null=True)),
                ("schedule_process", models.TextField(null=True)),
                ("created_by", models.CharField(max_length=100)),
                ("created_date", models.DateTimeField(auto_now=True)),
                ("modified_by", models.CharField(max_length=100, null=True)),
                ("modified_date", models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("version", models.CharField(default="1.0.0", max_length=10, verbose_name="Version")),
            ],
        ),
        migrations.CreateModel(
            name="TabScreens",
            fields=[
                ...
                ("user_configuration", models.TextField(null=True)),
                ...
                ("other_config", models.TextField(null=True)),
                ("update_version", models.CharField(default="1.0.0", max_length=50, null=True)),
            ],
        ),
        migrations.CreateModel(
            name="Tasks_Planner",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("shared_config", models.TextField(null=True)),
                ("created_by", models.CharField(max_length=100)),
                ("created_date", models.DateTimeField(auto_now=True)),
                ("modified_by", models.CharField(max_length=100, null=True)),
                ("modified_date", models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_developer",
                    models.BooleanField(blank=True, default=False, null=True, verbose_name="Developer"),
                ),
                (
                    "instance",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="users.instance"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("no_of_alert", models.IntegerField(null=True)),
                ("department", models.TextField(blank=True, null=True)),
                ("tagged_user", models.CharField(blank=True, max_length=30, null=True)),
                (
                    "instance",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="users.instance"),
                ),
        ...
        migrations.AddIndex(
            model_name="instance",
            index=models.Index(fields=["id"], name="users_insta_id_9e0824_idx"),
        ),
        migrations.AddIndex(
            model_name="instance",
            index=models.Index(fields=["name"], name="users_insta_name_0e7956_idx"),
        ),
        migrations.AddField(
            model_name="group_details",
            name="instance",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="users.instance"),
        ),
        migrations.AddField(
            model_name="failed_login_alerts",
            name="instance",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="users.instance"),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["instance"], name="users_userp_instanc_2bdd92_idx"),
        ),
        migrations.AddIndex(
            model_name="userpermission_interim",
            index=models.Index(fields=["instance"], name="users_userp_instanc_fb3c01_idx"),
        ),
        migrations.AddIndex(
            model_name="usergroup_approval",
            index=models.Index(fields=["instance"], name="users_userg_instanc_691439_idx"),
        ),
        migrations.AddIndex(
            model_name="user_navbar",
            index=models.Index(fields=["instance"], name="users_user__instanc_968872_idx"),
        ),
        migrations.AddIndex(
            model_name="user_navbar",
            index=models.Index(fields=["user_name"], name="users_user__user_na_c9fd87_idx"),
        ),
        migrations.AddIndex(
            model_name="user_model",
            index=models.Index(fields=["instance"], name="users_user__instanc_d0f220_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["instance"], name="users_user__instanc_b5bb1d_idx"),
        ),
        migrations.AddIndex(
            model_name="system_application_master",
            index=models.Index(fields=["instance"], name="users_syste_instanc_0fa6c9_idx"),
        ),
        migrations.AddIndex(
            model_name="system_application_master",
            index=models.Index(fields=["app_name"], name="users_syste_app_nam_dc64bf_idx"),
        ),
        migrations.AddIndex(
            model_name="profile",
            index=models.Index(fields=["instance"], name="users_profi_instanc_8753dc_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="profile",
            unique_together={("username", "instance")},
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["instance"], name="users_permi_instanc_6734a1_idx"),
        ),
        migrations.AddIndex(
            model_name="notification_management",
            index=models.Index(fields=["instance"], name="users_notif_instanc_3980a4_idx"),
        ),
        migrations.AddIndex(
            model_name="notification_management",
            index=models.Index(fields=["user_name"], name="users_notif_user_na_39ef26_idx"),
        ),
        migrations.AddIndex(
            model_name="login_trail",
            index=models.Index(fields=["instance"], name="users_login_instanc_c51f3b_idx"),
        ),
        migrations.AddIndex(
            model_name="group_details",
            index=models.Index(fields=["instance"], name="users_group_instanc_705b04_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="group_details",
        ...
        migrations.AddIndex(
            model_name="failed_login_alerts",
            index=models.Index(fields=["instance"], name="users_faile_instanc_22359d_idx"),
        ),
        migrations.AddIndex(
            model_name="dashboard_config",
            index=models.Index(fields=["instance"], name="users_dashb_instanc_2125c1_idx"),
        ),
        migrations.AddIndex(
            model_name="configuration_parameter",
            index=models.Index(fields=["instance"], name="users_confi_instanc_28ebef_idx"),
        ),
        migrations.AddIndex(
            model_name="audit_trail",
            index=models.Index(fields=["instance"], name="users_audit_instanc_dcb907_idx"),
        ),
        migrations.AddIndex(
            model_name="allocated_licences",
            index=models.Index(fields=["instance"], name="users_alloc_instanc_53944c_idx"),
        ),
        migrations.AlterUniqueTogether(
            name="allocated_licences",
            unique_together={("username", "instance")},
        ...
        migrations.AddIndex(
            model_name="user",
            index=models.Index(fields=["instance"], name="users_user_instanc_c462cb_idx"),
        ),
        migrations.AddIndex(
            model_name="user",
