...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
     ...
     //filterPlaceHolder: 'Show',
      ...
      infoTextFiltered: '<span class="" style="color:#b58d2b;">Showing</span> {0} from {1}', // when not all of the options are visible due to the filter
      ...
      btnMoveAllText: 'Select all',                                                         // string, sets the text for the "Move All" button
  ...
  function removeAll(dualListbox) {
    ...
    dualListbox.element.find('option').each(function(index, item) {
      ...
      //change_made_here
      console.log($item)
      console.log($item.prop("disabled"))
  ...
  BootstrapDualListbox.prototype = {
    ...
    setFilterPlaceHolder: function(value, refresh) {
      ...
      // this.elements.filterInput1.attr('placeholder', 'Show');
      // this.elements.filterInput2.attr('placeholder', 'Show');
      //this.settings.filterPlaceHolder = 'Show';
