...
Sidebar.prototype.addSearchPalette = function (expand) {
	...
	input.setAttribute('placeholder', "Search elements");
...
Sidebar.prototype.addGeneralPalette = function (expand) {
	...
	var fns = [
		this.createVertexTemplateEntry('shape=process;whiteSpace=wrap;html=1;backgroundOutline=1;', 120, 60, 'List View', 'L3-List view configuration', null, null, 'List view'),
		this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;', 80, 60, 'Create View', 'L3-Create view configuration', null, null, 'Create view'),
		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, 'Analysis', 'L3-Analysis configuration', null, null, 'Analysis'),
		this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;', 80, 80, 'Decision', 'Decision box configuration', null, null, 'Decision'),
		this.createVertexTemplateEntry('shape=parallelogram;perimeter=parallelogramPerimeter;whiteSpace=wrap;html=1;', 120, 60, 'Computation','Computation - Ability to write Python scripts and view output.',null,null, 'Computation'),
		this.createVertexTemplateEntry('shape=document;whiteSpace=wrap;html=1;boundedLbl=1;', 120, 80, 'Upload', 'Ability to create excel files'),
		this.createVertexTemplateEntry('shape=message;whiteSpace=wrap;html=1;outlineConnect=0;strokeColor=black;strokeWidth=1;', 80, 60, '', 'Scheduler - Ability to schedule tasks', null, null, 'Scheduler'),
		this.createVertexTemplateEntry('shape=cube;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;darkOpacity=0.05;darkOpacity2=0.1;', 120, 80, 'OCR', 'Ability to process text and characters within images',null,null,'OCR'),
		this.createVertexTemplateEntry('shape=hexagon;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;darkOpacity=0.05;darkOpacity2=0.1;', 120, 80, 'Pivot Report', 'Ability to prepare pivot report',null,null,'Pivot Report'),
		this.createVertexTemplateEntry('shape=flowlink;ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 70, 70, 'Flow Link From', 'Ability to link process flow between two subprocess',null,null,'Flow Link From'),
		this.createVertexTemplateEntry('shape=flowlinkto;ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 70, 70, 'Flow Link To', 'Ability to link process flow between two subprocess',null,null,'Flow Link To'),
		this.createVertexTemplateEntry('shape=octagon;whiteSpace=wrap;html=1;boundedLbl=1;backgroundOutline=1;darkOpacity=0.05;darkOpacity2=0.1;', 120, 80, 'Flex page', 'Ability to create flex pages',null,null,'Flex page'),
		this.createVertexTemplateEntry('shape=flowcontrol;whiteSpace=wrap;html=1;', 80, 80, 'Flow controller', 'Flow controller', null, null, 'Flow controller'),
	];
