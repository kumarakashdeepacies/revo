 ...
 */
url_string_1 = window.location.pathname
f_occ_1 = url_string_1.indexOf('/', url_string_1.indexOf('/') + 1)
s_occ_1 = url_string_1.indexOf('/', url_string_1.indexOf('/') + f_occ_1 +1)
t_occ_1 = url_string_1.indexOf('/', url_string_1.indexOf('/') + s_occ_1 +1)
app_code__2 = url_string_1.substring(f_occ_1+1,s_occ_1)
current_dev_mode__2 = url_string_1.substring(s_occ_1+1,t_occ_1)
 if(current_dev_mode__2 != "Build" && current_dev_mode__2 != "Edit"){
   current_dev_mode__2 = "User"
 }
mxEditor.prototype.urlPost = `/users/${app_code__2}/${current_dev_mode__2}/processCreationsave/`;
//mxEditor.prototype.urlPost = ROOT_PATH;
...
mxEditor.prototype.save = function (url, linefeed) {
	...
	if (url != null && url.length > 0) {
		...
		var data1 = this.writeGraphModel(linefeed);
		parser = new DOMParser();
		data = parser.parseFromString(data1, "text/xml");
